package com.in50us.springboot.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.in50us.springboot.repositories",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.in50us.springboot.model" });
